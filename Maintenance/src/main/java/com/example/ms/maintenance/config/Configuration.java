package com.example.ms.maintenance.config;
...
import com.example.ms.maintenance.controller.MaintenanceController;
...
public class Configuration
    ...
    private void initialize(MongoConfig mongo) {
        ...
        MongodbEntityRepository<Maintenance> maintenanceRepository
                = new MongodbEntityRepository<Maintenance>(mongo.getClient(),
                        mongo.getDbName(), Maintenance.class);
        maintenanceController = new MaintenanceController(maintenanceRepository);
    }
