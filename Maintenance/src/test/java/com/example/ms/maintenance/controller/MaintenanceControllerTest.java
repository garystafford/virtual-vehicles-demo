...
import com.example.ms.maintenance.Main;
...
public class MaintenanceControllerTest {
    ...
    private static final String BASE_URL = "http://localhost:8583";
    ...
    public void postDirectiveReplayRequest() throws IOException {
        HttpGet getRequest
                = new HttpGet(BASE_URL + "/virtualvehicle/maintenance/123.json");
