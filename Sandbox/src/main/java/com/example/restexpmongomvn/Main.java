...
import com.example.restexpmongomvn.config.MetricsConfig;
import com.example.restexpmongomvn.serialization.ResponseProcessors;
...
public class Main {
    ...
    private static final String SERVICE_NAME = "SampleRestService";
