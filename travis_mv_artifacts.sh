...
mv Vehicle/target/Vehicle-1.0-SNAPSHOT.jar 					artifacts/vehicles/Vehicle-1.${TRAVIS_BUILD_NUMBER}.jar
mv Vehicle/target/config/test/environment.properties 		artifacts/vehicles/environment.properties